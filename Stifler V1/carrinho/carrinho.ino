...
void loop() {
 ...
 distanciaCM = Ultrasonic.convert(microsec, Ultrasonic::CM);
  ...
  if(distanciaCM > 10){
  digitalWrite(PH1, HIGH);//O ESTADO HIGH, ACIONA O MOTOR A EM UMA DIREÇÃO.
  ...
  digitalWrite(PH2, LOW);
  digitalWrite(PH3, LOW);//O ESTADO HIGH, ACIONA O MOTO B EM UMA DIREÇÃO.
  digitalWrite(PH4, LOW);
  delay(700);
  ...
  digitalWrite(PH3, HIGH);//O ESTADO HIGH, ACIONA O MOTOR A EM UMA DIREÇÃO.
  digitalWrite(PH4, LOW);
